  ...
  "inline-flex items-center justify-center whitespace-nowrap rounded-xl text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 active:scale-[0.98]",
  {
    variants: {
      variant: {
        ...
        income:
          "bg-income text-white shadow hover:bg-emerald-600 font-semibold",
        expense:
          "bg-expense text-white shadow hover:bg-rose-600 font-semibold",
        gradient:
          "bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 text-white shadow-md hover:opacity-95 hover:shadow-indigo-500/25 hover:shadow-lg",
      },
      size: {
